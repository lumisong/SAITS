...
# Resolve repository root from this file location so imports keep working
# after moving this script into local_workspace/dataset_scripts/.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate DaQing oil Well logs dataset")
    ...
    parser.add_argument("--seq_len", help="sequence length", type=int, default=130)
    parser.add_argument(
        "--dataset_name",
    ...
    logger = setup_logger(
        ...
        "Generate DaQing Well lOgs dataset",
        mode="w",
    )
    logger.info(args)
